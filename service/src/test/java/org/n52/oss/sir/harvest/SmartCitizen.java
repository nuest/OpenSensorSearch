...
public class SmartCitizen {
    @Test
    public void harvestJSFile() throws Exception {
        File harvestScript = new File(ClassLoader.getSystemResource("Requests/harvestSmartCitizen.js").getFile());
