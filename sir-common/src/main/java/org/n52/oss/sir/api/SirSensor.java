...
public class SirSensor {
    ...
    public String toString() {
        ...
        sb.append("SirSensor: ");
        sb.append("internalSensorId: ").append(this.internalSensorId);
        sb.append(", Service description: ").append(this.servDescs);
        sb.append(", ").append(this.observedProperties);
        sb.append(", ").append(this.bBox);
        sb.append(", Timeperiod: ").append(this.timePeriod);
        sb.append(", Last update: ").append(this.lastUpdate);
        return sb.toString();
    }
